...
accuracies <- read.csv(paste('Results/Pred_Expression_GO_regress_adjPheno_common_', colnames(pheno)[trait],'_males.csv', sep=""), header=TRUE)
...
write.table(overlap_matrix, paste('Results/Overlap_Expression_top3GO_regress_adjPheno_common_', colnames(pheno)[trait],'_males.csv', sep=""), 
