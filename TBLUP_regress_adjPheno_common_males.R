...
###Load the data
#RRM
RRM <- as.matrix(read.table("Matrices/exp_cor_matrix_common_males.txt", header=TRUE, sep=" ", row.names=1))
...
###Load the data
#KRM
KRM <- as.matrix(read.table("Matrices/K_matrix_h_0.5_common_males.txt", header=TRUE, sep=" ", row.names=1))
...
###Load the data
#KRM
KRM <- as.matrix(read.table("Matrices/K_matrix_h_0.1_common_males.txt", header=TRUE, sep=" ", row.names=1))
...
###Write to a file
write.table(Results_final, paste('Results/Pred_Expression_regress_adjPheno_common_', colnames(pheno)[trait],'_males.csv', sep=""), 
